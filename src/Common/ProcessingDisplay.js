...
$ ./bin/spark-submit --class org.apache.spark.examples.SparkPi \\
                     ...
                     10
                      `;
        return (
            <div className="ProcessingDisplay">
                <h2><i className="fa fa-gears"/>Processing ({processing.pool_name})</h2>
                <div className="ProcessingDisplay-Display">
                    ...
                    <div className="ProcessingDisplay-Display-right">
                      <MetricDisplay metric={processing.max_cores}
                                     label="max core(s)" />
                      <MetricDisplay metric={processing.max_memory}
                                    label="max memory" />
                    </div>
                </div>
            </div>
