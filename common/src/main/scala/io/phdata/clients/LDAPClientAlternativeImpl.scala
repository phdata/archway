...
class LDAPClientAlternativeImpl[F[_]: Effect](ldapConfig: LDAPConfig, binding: LDAPConfig => LDAPBinding)
  ...
  override def validateUser(username: String, password: config.Password): OptionT[F, LDAPUser] =
    throw new NotImplementedError()
  ...
  override def addUserToGroup(groupName: DistinguishedName, distinguishedName: DistinguishedName): OptionT[F, String] =
    throw new NotImplementedError()

  override def removeUserFromGroup(
      groupName: DistinguishedName,
      distinguishedName: DistinguishedName
  ): OptionT[F, String] = throw new NotImplementedError()
